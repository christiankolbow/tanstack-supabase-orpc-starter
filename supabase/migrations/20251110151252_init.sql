create type "public"."todo_status" as enum ('open', 'in_progress', 'completed');


  create table "public"."todos" (
    "id" bigint generated by default as identity not null,
    "todo" text not null,
    "status" public.todo_status not null default 'open'::public.todo_status,
...
grant update on table "public"."todos" to "service_role";
  ...
  create policy "all_authenticated"
  on "public"."todos"
  as permissive
  for all
  to authenticated
